...
class RemoteFinancialPharmacyDetailsDataSource
  ...
  Future<FinancialPharmacyDetailsModel>
    ...
    try {
      final response = await dio.get(
        ApiEndpoints.financialPharmacyDetails(
          pharmacyId,
        ),
        queryParameters: {
      ...
      if (responseData is! Map) {
        throw Exception(
          'صيغة بيانات بطاقة الصيدلية غير صحيحة',
        );
      }
      ...
      throw Exception(
        'حدث خطأ أثناء تحميل بطاقة الصيدلية',
      );
    }
  }
  ...
  String _handleDioError(DioException error) {
    ...
    switch (error.type) {
      ...
      case DioExceptionType.badResponse:
        return 'تعذر تحميل بطاقة الصيدلية';
